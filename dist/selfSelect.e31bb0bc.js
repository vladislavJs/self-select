...
var getTemplate = function getTemplate() {
  ...
  var text = placeholder || 'some text';
  var cls = '';
  var items = data.map(function (item) {
    ...
    return "<li class=\"select__item ".concat(cls, "\" data-type=\"item\" data-value=\"").concat(item.id, "\">").concat(item.value, "</li>");
  });
...
var Select = /*#__PURE__*/function () {
  ...
  _createClass(Select, [{
    ...
    value: function select(id) {
      ...
      this.$el.querySelectorAll('[data-type="item"]').forEach(function (i) {
        return i.classList.remove('selected');
      });
      this.$el.querySelector("[data-value=\"".concat(this.selectedId, "\"]")).classList.add('selected');
...
var select = new _select.Select('#select', {
  ...
  onSelected: function onSelected(item) {
    console.log("new item is ".concat(item));
  }
});
window.s = select;
},{"/select/select":"select/select.js","./select/style.scss":"select/style.scss"}],"../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "57318" + '/');
...
//# sourceMappingURL=/selfSelect.e31bb0bc.js.map